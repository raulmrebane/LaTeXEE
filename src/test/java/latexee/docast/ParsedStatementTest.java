...
public class ParsedStatementTest {
	...
	public void ParsingTest3() { //TODO: really doesn't parse correctly or the just tree is faulty?
		ParsedStatement ps = new ParsedStatement("", 0, new ArrayList<ParsedStatement>(Arrays.asList(
	...
	public void ParsingTest10() {
		ParsedStatement ps = new ParsedStatement("", 0, new ArrayList<ParsedStatement>(Arrays.asList(
				new IncludeStatement("parsing11.tex", 0),
				new IncludeStatement("parsing12.tex", 0)
			)));
	...
	public void ParsingTest13() { //MYSTERY BUG
		ParsedStatement ps = new ParsedStatement("", 0, new ArrayList<ParsedStatement>(Arrays.asList(
				new IncludeStatement("src/test/antlr/parsing14.tex", 0)
			)));
	...
	public void ParsingTest14() { //THE SAME MYSTERY BUG
		ParsedStatement ps = new ParsedStatement("", 0, new ArrayList<ParsedStatement>(Arrays.asList(
				new IncludeStatement("src/test/antlr/parsing13.tex", 0)
			)));
	...
	public void ParsingTest15() {
		ParsedStatement ps = null; //TODO
		ParsedStatement ps2 = DocumentParser.parse(DocumentParser.getFileContent("src/test/antlr/parsing15.tex"), new ArrayList<>());
		assertTrue(compareTrees(ps, ps2));
	}
	...
	public boolean compareTrees(ParsedStatement actual, ParsedStatement result) { //TODO!
